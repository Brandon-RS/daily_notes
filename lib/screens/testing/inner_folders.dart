...
class InnerFolder extends StatefulWidget {
  ...
  @override
  State<InnerFolder> createState() => _InnerFolderState();
}

class _InnerFolderState extends State<InnerFolder> {
                              ...
                              if (f.type.toString().contains("file")) {
                                ...
                                return InkWell(
                                  onTap: () {
                                    ...
                                    var foldersList = myDir.listSync(recursive: true, followLinks: false);

                                    for (int k = 0; k < foldersList.length; k++) {
                                      var config = File(foldersList[k].path);
                                      print("IsFile $config");
                                    }
                                    print(foldersList);
                                  },
